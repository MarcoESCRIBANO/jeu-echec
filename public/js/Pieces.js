...
class Pions extends Pièces{
    ...
    getMouvPossibilité(){
        ...
        if(this.couleur=="Blanc"){
            ...
            if(y+1<8 && this.plateau.getPièce(x,y+1)==undefined){
                mouvPossibilité.push([x,y+1]);
            }
            if(y+2<8 && this.isFirstMouv() && this.plateau.getPièce(x,y+2)==undefined){
                mouvPossibilité.push([x,y+2]);
            }
            if(y+1<8 && x+1<8 && this.plateau.getPièce(x+1,y+1)!=undefined && this.plateau.getPièce(x+1,y+1).getPiècesCouleur()!=this.getPiècesCouleur()){
                mouvPossibilité.push([x+1,y+1]);
            }
            if(y+1<8 && x-1>=0 && this.plateau.getPièce(x-1,y+1)!=undefined && this.plateau.getPièce(x-1,y+1).getPiècesCouleur()!=this.getPiècesCouleur()){
                mouvPossibilité.push([x-1,y+1]);
            }
        }
        else{
            ...
            if(y-1>=0 && this.plateau.getPièce(x,y-1)==undefined){
                mouvPossibilité.push([x,y-1]);
            }
            if(y-2>=0 && this.isFirstMouv() && this.plateau.getPièce(x,y-2)==undefined){
                mouvPossibilité.push([x,y-2]);
            }
            if(y-1>=0 && x+1<8 && this.plateau.getPièce(x+1,y-1)!=undefined && this.plateau.getPièce(x+1,y-1).getPiècesCouleur()!=this.getPiècesCouleur()){
                mouvPossibilité.push([x+1,y-1]);
            }
            if(y-1>=0 && x-1>=0 && this.plateau.getPièce(x-1,y-1)!=undefined && this.plateau.getPièce(x-1,y-1).getPiècesCouleur()!=this.getPiècesCouleur()){
                mouvPossibilité.push([x-1,y-1]);
            }
        }
        return mouvPossibilité;
